...
UPDATE Funcionario SET salario_func = salario_func * 0.9 WHERE funcao_func = 'Mecânico' and sexo_func = 'Masculino';
#Reduza o valor em 30% nos produtos com estoque maior que 20.
UPDATE Produto SET valor_prod = valor_prod * 0.7 WHERE estoque_prod > 20;
#Dê um desconto de 15% no valor total das vendas com forma de pagamento ‘A vista’ e com valor maior do que R$ 1.000,00.
UPDATE Venda SET valor_vend = valor_vend * 0.85 WHERE forma_pag_vend = 'A vista' and valor_vend > 1000;
